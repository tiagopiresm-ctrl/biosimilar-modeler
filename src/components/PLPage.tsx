  ...
  const sections: { title: string; rows: RowDef[] }[] = [
    ...
    },
    {
      ...
      rows: [
        ...
        { label: 'R&D & Regulatory', unit: `${config.currency}'000`, data: plOutputs.rAndD, decimals: 0 },
    ...
    <div>
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm border-collapse">
          <thead>
            <tr>
              <th className="header-cell text-left sticky left-0 bg-gray-100 z-10 min-w-[250px]">Line Item</th>
